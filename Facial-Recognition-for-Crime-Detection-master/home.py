...
pages = []
for i in range(5):
    pages.append(tk.Frame(root, bg="#37517e"))
...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file= r"E:\Final Project-main\Facial-Recognition-for-Crime-Detection-master\img\back.png")
    ...
    right_frame = tk.LabelFrame(content, text="Detected", bg="#3E3B3C", font="Arial 20 bold", bd=4,
...
def selectMultiImage(opt_menu, menu_var):
    ...
    if(len(path_list) < 5):
        ...
        back_img = tk.PhotoImage(file=r"E:\Final Project-main\Facial-Recognition-for-Crime-Detection-master\img\previous.png")
        next_img = tk.PhotoImage(file=r"E:\Final Project-main\Facial-Recognition-for-Crime-Detection-master\img\next.png")
...
def getPage1():
    ...
    basicPageSetup(1)
    heading.configure(text="Register Criminal", bg="#37517e")
    ...
    # Adding Input Fields
    input_fields = ("Name", "Father's Name", "Gender", "DOB(yyyy-mm-dd)", "Missing Person/Criminal", "Profile Image")
...
def getPage2():
    ...
    basicPageSetup(2)
    heading.configure(text="Image Surveillance",bg="#37517e")
    right_frame.configure(text="Detected", fg="white")
...
def getPage4(path):
    ...
    right_frame.configure(text="Detected")
...
def getPage3():
    ...
    basicPageSetup(3)
    heading.configure(text="Video Surveillance",bg="#37517e")
...
######################################## Home Page ####################################
tk.Label(pages[0], text="Face Recognition System for Criminal Detection", fg="white", bg="#37517e",
      font="Arial 25 bold", pady=30).pack()

logo = tk.PhotoImage(file = r"E:\Final Project-main\Facial-Recognition-for-Crime-Detection-master\img\logo2.png")
tk.Label(pages[0], image=logo, bg="#37517e").pack(side='left',padx=100)

btn_frame = tk.Frame(pages[0], bg="#37517e", pady=60)
btn_frame.pack()
...
for btn in btn_frame.winfo_children():
    btn.configure(
        font=("Arial", 20),  # Use a tuple for font style and size
        width=17,
        bg="#2D2C2C",  # Background color
        fg="white",  # Text color
        pady=15,
        bd=2,  # Remove default border
        highlightthickness=2,  # Set border thickness
        highlightbackground="#47b2e4",  # Border color when not focused
        highlightcolor="#47b2e4",  # Border color when focused
        activebackground="#3E3B3C",  # Background color when button is pressed
        activeforeground="white"  # Text color when button is pressed
    )
    btn.pack(pady=20)  # Add vertical spacing between buttons
